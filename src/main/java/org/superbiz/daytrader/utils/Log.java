 ...
 */
package org.superbiz.daytrader.utils;
...
public class Log {
    ...
    {
        LOGGER.log(Level.FINE, "DayTrader Log:" + new java.util.Date() + "------\n\t ");
    ...
    {
        LOGGER.log(Level.FINEST, message + " threadID="+ Thread.currentThread());
    }
    ...
    {
        LOGGER.log(Level.FINEST, "Method enter --" + message);
    }
    public static void traceExit(String message)
    {
        LOGGER.log(Level.FINEST, "Method exit  --" + message);
    }
