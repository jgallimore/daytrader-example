 ...
 */
package org.superbiz.daytrader.web;
...
import org.superbiz.daytrader.entities.AccountProfileDataBean;
...
import org.superbiz.daytrader.core.api.TradeServices;

import org.superbiz.daytrader.core.beans.MarketSummaryDataBean;
import org.superbiz.daytrader.core.beans.RunStatsDataBean;
import org.superbiz.daytrader.core.direct.FinancialUtils;
import org.superbiz.daytrader.core.direct.TradeJDBCDirect;
import org.superbiz.daytrader.core.direct.TradeJEEDirect;
import org.superbiz.daytrader.core.direct.TradeJPADirect;
...
public class TradeAction implements TradeServices {
    ...
    private void createTrade() {
        ...
        if (TradeConfig.runTimeMode == TradeConfig.EJB3) {
            try {
                Class c = Class.forName("org.superbiz.daytrader.web.ejb3.TradeSLSBBean");
                if ((trade == null) ||
            ...
            try {
                Class c = Class.forName("org.superbiz.daytrader.web.ejb3.DirectSLSBBean");
                if ((trade == null) ||
                    (!(trade.getClass().isAssignableFrom(c)))) {
                    InitialContext context = new InitialContext();
                    try {
